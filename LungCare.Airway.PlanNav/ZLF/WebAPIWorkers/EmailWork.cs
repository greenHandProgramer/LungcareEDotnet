...
namespace LungCare.SupportPlatform.WebAPIWorkers
{
    public class EmailWork
    {
        ...
        public EmailWork(string server, string toMail, string subject, string emailBody, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
                mMailMessage = new MailMessage();
                mMailMessage.To.Add(toMail);
                mMailMessage.From = new MailAddress("514144641@qq.com");
                ...
                this.mSenderUsername = "514144641";
                this.mSenderPassword = "qazwsx147258369";
