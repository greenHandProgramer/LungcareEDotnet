...
namespace LungCare.SupportPlatform.UI.Windows.Examination
{
    ...
    /// </summary>
    public partial class UploadProgressWndResultMA : Window
    {
        ...
        public UploadProgressWndResultMA()
        {
            InitializeComponent();
        ...
        public UploadProgressWndResultMA(string orderID)
        {
            InitializeComponent();
            borderMessage.MouseDown += borderMessage_MouseDown;
        ...
        public void LoginAndUpload()
        {
            ...
            LoginRequest.Password = "admin18600406312";
                ...
                云数据类型Enum.处理结果,
                 ...
                 successCallback: delegate ()
                 {
                     this.Dispatcher.Invoke(new Action(delegate ()
                     {
                         ...
                         {
                             Close();
                             //LungCare_Airway_PlanNav.MainWindow.Instance.Switch2UploadList();
                         };
                         Dicom成功上传.Evt继续上传 += delegate
                         {
                             Close();
                             //LungCare_Airway_PlanNav.MainWindow.Instance.Switch2UploadWindowThenPopupFileSelectDialog();
                         };
        ...
        {
            //LungCare_Airway_PlanNav.MainWindow.Instance.BringIntoView();
        }

        private void btnMin_MouseDown(object sender, MouseButtonEventArgs e)
        {
            this.WindowState = System.Windows.WindowState.Minimized;
            //LungCare_Airway_PlanNav.MainWindow.Instance.WindowState = System.Windows.WindowState.Minimized;
        }
    }
}
