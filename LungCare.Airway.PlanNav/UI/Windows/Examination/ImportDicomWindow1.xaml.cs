...
namespace LungCare.SupportPlatform.UI.Windows.Examination
{
    ...
    /// </summary>
    public partial class ImportDicomWindow1 : Window
    {
        public ImportDicomWindow1()
        {
            InitializeComponent();
            LoadComponent();
        }

        public ImportDicomWindow1(string dicomPath)
        {
            InitializeComponent();
            LoadComponent();
            if (_dictionary != null)
        ...
        void btnSaveCT_Click(object sender,EventArgs e) {
            ...
            {
                System.Windows.Forms.MessageBox.Show("未发现文件!");
                return;
            }
